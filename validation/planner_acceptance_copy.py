...
DEFAULT_CONFIG = ROOT / "config/scenarios/planner_acceptance_v2.json"
...
def run_acceptance(output: FilePath, config_path: FilePath = DEFAULT_CONFIG,
    ...
    for folder in ("core","environment","planner","controller","physics","simulation","validation","visualization","tests","config"):
    ...
    source_files = []
    for folder in ("core","environment","planner","controller","physics","simulation","validation","visualization","tests"):
